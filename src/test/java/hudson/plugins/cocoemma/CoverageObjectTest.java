...
public class CoverageObjectTest extends AbstractEmmaTestBase {
    ...
    public void testPrintRatioTable() throws Exception {
        ...
        String expected = "<table class='percentgraph' cellpadding='0px' cellspacing='0px'><tr class='percentgraph'><td width='64px' class='data'>0.0%</td><td class='percentgraph'><div class='percentgraph'><div class='greenbar' style='width: 0.0px;'><span class='text'>0/100</span></div></div></td></tr></table>";
        String str = b.toString().replace( ",", ".");
    	assertEquals(str,expected);
    	r = new Ratio(51,200);
    	b = new StringBuilder();
    	CoverageObject.printRatioTable(r, b, no_tests_required);
    	expected = "<table class='percentgraph' cellpadding='0px' cellspacing='0px'><tr class='percentgraph'><td width='64px' class='data'>25.5%</td><td class='percentgraph'><div class='percentgraph'><div class='greenbar' style='width: 25.5px;'><span class='text'>51/200</span></div></div></td></tr></table>";
    ...
    public void testPrintColumnt() throws Exception {
    	...
    	CoverageObject.printRatioCell(false, r, b, no_tests_required);
        String str = b.toString().replace( ",", "." );
        String expected = "<td class='nowrap' data='025.50'>\n" +
